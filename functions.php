...
add_action( 'init', 'Blog Content' );
function book_retailers() {  
    register_post_type( 'Blog Content',  
        array(  
            'labels' => array(  
                'name' => __( 'Blog Content' , 'dynasty3'),
                'singular_name' => __( 'Blog Content' , 'dynasty3'), 
                'add_new' => __('Add New Book Retailers', 'dynasty3'),
				'edit_item' => __('Edit Book Retailers', 'dynasty3'), 
                'new_item' => __('New Book Retailers', 'dynasty3'),  
                'view_item' => __('View Book Retailers', 'dynasty3'), 
                'search_items' => __('Search Book Retailers', 'dynasty3'), 
                'not_found' => __('No Book Retailers found', 'dynasty3'),
                'not_found_in_trash' => __('No Book Retailers found in Trash', 'dynasty3') 
            ),  
            'public' => true, 
            'menu_position' => 22,  
          //  'rewrite' => array('slug' => 'single-medical-gallery'),
